...
class NST:
    ...
    def load_model(self):
        """
        Loads the VGG19 model and retrieves specific layers for content and style
        """
    ...
    def generate_features(self):
        """
        Extracts style and content features from the style and content images
        """
    ...
    def style_cost(self, style_outputs):
        """
        Calculates the total style cost from all layers
        """
        style_cost = 0
    ...
    def total_cost(self, generated_image):
        """
        Calculates the total cost: content cost + style cost
        """
    ...
    def compute_grads(self, generated_image):
        """
        Computes gradients with respect to the generated image
        """
